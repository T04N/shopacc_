...
<head>
  ...
  <title>@yield('title', 'Shards Dashboard Lite - Free Bootstrap Admin Template – DesignRevision')</title>
  ...
  <link rel="stylesheet" href="{{ asset('./css/dashBoardSeller.css') }}">
  <style>
    .navbar-nav .nav-item .nav-link:active {
        color: rgb(255, 71, 84) !important;
      }
  </style>
  @stack('styles')
</head>
      ...
      <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          ...
          <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
            <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
              <div class="d-table m-auto">
                <span class="d-none d-md-inline ml-1">Seller Dashboard</span>
              </div>
            </a>
        ...
        <div class="nav-wrapper">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('sellerDashboard.index') }}">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('sellerDashboard.upAcc') }}">
                <i class="material-icons">note_add</i>
                <span>Thêm tài khỏan</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('sellerDashboard.table') }}">
                <i class="material-icons">table_chart</i>
                <span>Danh sách tài khoản</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('sellerDashboard.user') }}">
                <i class="material-icons">person</i>
                <span>User Profile</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('sellerDashboard.rating') }}">
                <i class="material-icons">table_chart</i>
                <span>Rating</span>
              </a>
            </li>
